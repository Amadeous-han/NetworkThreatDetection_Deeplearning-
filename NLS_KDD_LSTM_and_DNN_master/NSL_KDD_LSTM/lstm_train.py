...
from NSL_KDD.NLS_KDD_LSTM_and_DNN_master.NSL_KDD_LSTM import lstm_inference
...
MODEL_SAVE_PATH = "E:\\大四下毕业设计\\py_code\\NSL_KDD\\NLS_KDD_LSTM_and_DNN_master\\NSL_KDD_LSTM\\model"
    ...
    with tf.Session() as sess:  
        ...
        for i in range(train_step):
            ...
            if(i%50 == 0):
                ...
                put_text( "step: %d ,loss on training batch: %g ,accuracy on test data: %g" % (i, loss_value, accuracy_value))
