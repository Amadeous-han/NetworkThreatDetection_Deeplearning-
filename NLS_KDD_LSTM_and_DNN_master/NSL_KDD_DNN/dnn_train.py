...
MODEL_SAVE_PATH = "E:\\大四下毕业设计\\py_code\\NSL_KDD\\NLS_KDD_LSTM_and_DNN_master\\NSL_KDD_DNN\\model"#"./model/"#
MODEL_NAME = "mlpmodel.ckpt"
...
def main(argv=None):
    file_path = "KDDTest-21_processed.csv"
